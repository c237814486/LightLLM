...
pip install -v .
pip install numexpr transformers==4.51.1
...
pip install -r requirements.txt
pip install /mnt/afs/yangdeyu/TTS/TTS_infer/CosyVoice/pretrained_models/CosyVoice-ttsfrd/ttsfrd_dependency-0.1-py3-none-any.whl
pip install /mnt/afs/yangdeyu/TTS/TTS_infer/CosyVoice/pretrained_models/CosyVoice-ttsfrd/ttsfrd-0.4.2-cp310-cp310-linux_x86_64.whl