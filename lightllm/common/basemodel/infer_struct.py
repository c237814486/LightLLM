...
class InferStateInfo:
    ...
    def init_some_extra_state(self, model, input_ids: torch.Tensor):
        if self.is_prefill:
            (self.b_q_seq_len, self.b1_cu_q_seq_len, self.b_kv_seq_len, self.b1_cu_kv_seq_len, self.position_ids, self.max_q_seq_len, self.max_kv_seq_len,) = gen_prefill_params(
