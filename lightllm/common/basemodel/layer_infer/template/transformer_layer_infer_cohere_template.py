...
from lightllm.common.basemodel.layer_infer.template.transformer_layer_infer_template import (
...
class TransformerLayerCohereInferTpl(TransformerLayerInferTpl):
    ...
    def _get_qkv(self, input, infer_state: InferStateInfo, layer_weight) -> Tuple[torch.Tensor, torch.Tensor, torch.Tensor]:
