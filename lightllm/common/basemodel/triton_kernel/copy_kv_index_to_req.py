...
@triton.jit
def _fwd_kernel_copy_kv_index_to_req(req_to_token_indexs, b_req_idx, b_seq_len, memindex, stride_req_to_token_b, stride_req_to_token_s):
...
def _fwd_kernel_copy_kv_index_to_req_prefill(
    ...
    dest_offset = req_to_token_indexs + cur_req_idx * stride_req_to_token_b + (cur_ready_cache_len + block_range) * stride_req_to_token_s
