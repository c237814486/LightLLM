...
def _bitonic_merge(
    ...
    x_1,
    ids,
    stage: tl.core.constexpr,
    order: tl.core.constexpr,
    n_dims: tl.core.constexpr,
):
    """
...
def argsort(
    ...
    x_1,
    ids,
    dim: tl.core.constexpr = None,
    descending: tl.core.constexpr = tl.core.CONSTEXPR_0,
):
...
def grouped_topk_kernel(
    ...
    tl.store(
        scores_buffer_ptr + scores_stride_m * token_index + offs_n,
        scores,
        mask=offs_n < total_expert_num,
    )
