...
from lightllm.models.bloom.triton_kernel.token_flashattention_nopad import (
    token_attention_fwd,
)
...
class BloomTransformerLayerInfer(TransformerLayerInferTpl):
    ...
    def _get_qkv(self, input, infer_state: InferStateInfo, layer_weight: BloomTransformerLayerWeight) -> Tuple[torch.Tensor, torch.Tensor]:
