...
@triton.jit
def _fwd_kernel_flash_decode_stage1_padding_fp8(
    Q_nope,
    Q_rope,
    KV_nope,
    KV_rope,
...
def flash_decode_stage1_fp8(
    ...
    **run_config,
    ...
    kernel = _fwd_kernel_flash_decode_stage1_padding_fp8.warmup(
        q_nope,
        q_rope,
        kv_nope,
        kv_rope,
    ...
    _fwd_kernel_flash_decode_stage1_padding_fp8[grid](
        q_nope,
        q_rope,
        kv_nope,
        kv_rope,
