...
class StarcoderPreLayerInfer(PreLayerInfer):
    ...
    def context_forward(
        ...
        layer_weight: PreAndPostLayerWeight,
    ):
        ...
        position_embeds = self.alloc_tensor(
            (infer_state.position_ids.shape[0], layer_weight.wpe_weight_.shape[1]),
            dtype=layer_weight.data_type_,
        )
        embedding(
            infer_state.position_ids,
            layer_weight.wpe_weight_,
            0,
            layer_weight.wpe_weight_.shape[0],
            position_embeds,
        )
