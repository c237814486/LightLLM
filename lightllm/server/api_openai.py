...
async def _process_prompts_completion(
    ...
    async def process_single_prompt(prompt: Union[str, List[int]], prompt_index: int):
        ...
        return await _collect_generation_results(generator, request, prompt_str, prompt_index, individual_sampling_params)
...
async def _collect_generation_results(generator, request: CompletionRequest, prompt: str, prompt_index: int, sampling_params: SamplingParams):
    final_output = []
